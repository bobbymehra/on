<%@ Page Title="" Language="C#" MasterPageFile="~/GrocerySite.master" AutoEventWireup="true" CodeFile="Dals.aspx.cs" Inherits="Dals" EnableEventValidation="false" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    <div style="float: left; width: 120px">
        <fieldset class="fieldsetmain">
            <legend style="font-size: 20px;">Dals</legend>
                    ...
                    <table>
                        <tr>
                            <td style="border-style: dashed; border-width: 1px;">
                                ...
                                <br />
                                Product Name:
            <asp:Label ID="NameLabel" runat="server" Text='<%# Eval("Tata Sampann 100% Organic Moong Dal ") %>' />
                                <br />
                                Description:
            <asp:Label ID="DiscriptionLabel" runat="server" Text='<%# Eval("100% Organic Moong Dal") %>' />
                                <br />
                                Price:
            <asp:Label ID="PriceLabel" runat="server" Text='<%#"$"+ Eval("₹ 125.00") %>' />
                                <br />
                                Enter The Quantity:&nbsp;
